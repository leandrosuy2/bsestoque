                ...
                <tr class="border-b last:border-0 hover:bg-gray-50 transition">
                    ...
                    <td class="px-4 py-3 text-right">
                        <div class="flex justify-end gap-2">
                            <a href="#" class="inline-flex items-center gap-1 text-blue-600 hover:text-blue-800 font-medium px-2 py-1 rounded hover:bg-blue-50 transition">
                            ...
                            <form action="#" method="POST">
                                <button type="button" class="inline-flex items-center gap-1 text-white bg-gradient-to-r from-gray-600 to-gray-500 hover:from-gray-700 hover:to-gray-600 font-semibold px-3 py-1.5 rounded-lg shadow focus:outline-none focus:ring-2 focus:ring-gray-500 transition">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
